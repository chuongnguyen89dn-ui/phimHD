...
if(path==='/')return send(res,200,{service:'Ivy yt-dlp mux backend',version:'0.1.0',clients:CLIENTS,ffmpeg:Boolean(ffmpegPath)});
...
server.listen(PORT,'0.0.0.0',()=>console.log('Ivy yt-dlp mux backend listening',PORT));